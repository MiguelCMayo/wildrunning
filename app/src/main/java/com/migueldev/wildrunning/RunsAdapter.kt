...
class RunsAdapter(private val runsList: ArrayList<Runs>) :RecyclerView.Adapter<RunsAdapter.MyViewHolder>() {
    ...
    public class MyViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        val tvStartTime: TextView = itemView.findViewById(R.id.tvStartTimee)
        ...
        val ivPicture: ImageView = itemView.findViewById(R.id.ivPicturee)

        val lyPicture: LinearLayout = itemView.findViewById(R.id.lyPicturee)
        val tvPlay: TextView = itemView.findViewById(R.id.tvPlay)
        val tvDelete: TextView = itemView.findViewById(R.id.tvDeletee)
    }
